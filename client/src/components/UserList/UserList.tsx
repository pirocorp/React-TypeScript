            ...
            <tbody>
                {
                    users.map(user =>
                        <UserItem
                            key={user._id}
                            user={user}
                            onDetailsClick={actionClickHandler.bind(null, UserAction.Details)}
                            onEditClick={actionClickHandler.bind(null, UserAction.Edit)}
                            onDeleteClick={actionClickHandler.bind(null, UserAction.Delete)}
                        />)
                }
            </tbody>
        </table>
